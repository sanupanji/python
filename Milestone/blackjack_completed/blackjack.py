...
def start(inhandmoney):
    ...
    if (inhandmoney - dealmoney) >= 0:
        ...
        plyerman(lscardman, Hit, inhandmoney, dealmoney, lines[1:],
...
def plyerman(lscard, Hit,  inhandmoney, dealmoney, linesplayer, hiddenls, lscompvalue):
    ...
    if hitstand == " ":
        ...
        computerprint([hiddenls[0]], lscompvalue,
                      linesplayer, lscard, inhandmoney, dealmoney)
    ...
    while Hit == True:
        ...
        if hitstand == " ":
            ...
            computerprint([hiddenls[0]], lscompvalue, ls[2]
                          [1:len(lscard)+1], lscard, inhandmoney, dealmoney)


def computerprint(compcardlist, compvalue, playerls, lsplyercard, inhand, betting):
